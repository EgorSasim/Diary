...
import { CreateSpaceModalModule } from 'src/app/modules/common/spaces/create-space/create-space-modal.module';

@NgModule({
  declarations: [SidePannelComponent],
  imports: [LightboxModule, CommonModule, CreateSpaceModalModule],
